package ca.uhn.fhir.jpa.starter.gravity.controllers;
...
import ca.uhn.fhir.jpa.starter.gravity.database.Database;
import ca.uhn.fhir.jpa.starter.gravity.utils.AuthUtils;
import ca.uhn.fhir.jpa.starter.gravity.endpoints.AuthorizationEndpoint;
import ca.uhn.fhir.jpa.starter.gravity.endpoints.RegistrationEndpoint;
import ca.uhn.fhir.jpa.starter.gravity.endpoints.TokenEndpoint;
import ca.uhn.fhir.jpa.starter.gravity.endpoints.IntrospectionEndpoint;
...
public class AuthorizationController {
  ...
  public ResponseEntity<String> postRegisterClient(HttpServletRequest request, HttpEntity<String> entity,
    ...
    return RegistrationEndpoint.handleRegisterClient(redirectUri);
  }
