...
public class SdohCapabilityStatementProvider {
  ...
  public CapabilityStatement getServerConformance(IBaseConformance theCapabilityStatement, HttpServletRequest theRequest, RequestDetails theRequestDetails) {
